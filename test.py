...
if __name__ == '__main__':
    ...
    # parser.add_argument('--test_image_path', type=str, default='./10/Test/image')
    # parser.add_argument('--test_mat_path', type=str, default='./datasets/Test/mat')

    # parser.add_argument('--train_image_path', type=str, default='./datasets/crop/video')  # 路径
    # parser.add_argument('--train_mat_path', type=str, default='./10/Mat')
